...
function [QN_I, QN_F] = RateMatchingForPolarCode(InputBits, NumOfBitsToEncode, RateMatchingOutSeqLength, NumberOfParityCheckBits, PolarSeq, IndexesAfterSubBlockInterleaving)
